...
<head>
    ...
    <style>
        ...
        .site-doc-icon li{display: inline-block; vertical-align: middle; width: 127px; height: 105px; line-height: 25px; padding: 20px 0; margin-right: 5px; margin-bottom: 5px; border: 1px solid #e2e2e2; font-size: 14px; text-align: center; color: #666; transition: all .3s; -webkit-transition: all .3s;}
        ...
        .site-doc-icon li.selected{background-color: #f2f2f2; color: #000; border: 1px solid #ff2c47;}
